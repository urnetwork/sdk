...
Build a local package with `make -C sdk/ruby` and verify it with
`make -C sdk/ruby check-package`. Native desktop builds reuse the CGo module;
...
[language examples](https://github.com/urnetwork/examples/tree/main/ruby).
